...
class BackendTester:
    ...
    def test_cors_security(self):
        ...
        # Test allowed origin
        headers = {
            'Origin': 'https://golfguy-platform.preview.emergentagent.com',
    ...
    def test_payment_system_stripe_api(self):
        ...
        checkout_data = {
            ...
            "success_url": "https://golfguy-platform.preview.emergentagent.com/payment/success",
            "cancel_url": "https://golfguy-platform.preview.emergentagent.com/payment/cancel"
        }
